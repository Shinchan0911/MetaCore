...
En: MetaCore is back, filtered for redundant features and will focus on developing necessary features
...
```
It will download `metacore` from NPM repositories

### Bleeding edge
If you want to use bleeding edge (directly from github) to test new features or submit bug report, this is the command for you:
```bash
npm install shinchan0911/metacore
```
...
You can see it [here](https://github.com/Schmavery/facebook-chat-api?tab=readme-ov-file#Documentation).
